...
- The arrow is a plain one rather than the U+1F846 the bash prompt uses, which few fonts carry. A code point nothing can draw is worse than a plainer one everything can.
