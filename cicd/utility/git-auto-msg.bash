#!/usr/bin/env bash
# Non-interactive GIT_EDITOR for the cicd publish stage. git invokes it as
# `git-auto-msg.bash <msgfile>`. If the message is empty (a plain `git commit`
# with no -m), fill it from $GIT_AUTO_MESSAGE; if git already pre-filled one
